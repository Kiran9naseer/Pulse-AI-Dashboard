...
st.markdown("""
    <style>
        ...
        /* Hide ALL Streamlit Branding & Toolbar Elements */
        header, footer, .stDeployButton, #MainMenu, .viewerBadge_container__1QSob, .viewerBadge_link__1S137, [data-testid="stToolbar"] {
